...
/obj/machinery/chem_master/attack_ai(var/mob/user)
	return src.attack_hand(user)

/obj/machinery/chem_master/attack_hand(var/mob/user)
	if(inoperable())
		return
...
/obj/machinery/reagentgrinder/attack_ai(var/mob/user)
	return 0

/obj/machinery/reagentgrinder/attack_hand(var/mob/user)
	interact(user)

/obj/machinery/reagentgrinder/interact(var/mob/user) // The microwave Menu
	if(inoperable())
		return
	user.set_machine(src)
