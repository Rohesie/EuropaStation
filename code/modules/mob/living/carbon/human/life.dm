...
#define HUMAN_CRIT_MAX_OXYLOSS ( MOB_BREATH_DELAY * SS_MOB_TR * (HUMAN_CRIT_HEALTH_CUSHION/HUMAN_CRIT_TIME_CUSHION) )
...
/mob/living/carbon/human/handle_environment(datum/gas_mixture/environment)
	...
	for(var/g in environment.gas)
		if((SSmaterials.gas_flags[g] & XGM_GAS_CONTAMINANT) && environment.gas[g] > SSmaterials.gas_overlay_limits[g] + 1)
			pl_effects()
			break
