...
/obj/item/organ/internal/lungs/proc/sync_breath_types()
	...
	poison_type = species.poison_type ? species.poison_type : MATERIAL_FUEL
...
/obj/item/organ/internal/lungs/proc/handle_breath(datum/gas_mixture/breath)
	...
	if(breath.gas[MATERIAL_N2O])
		var/SA_pp = (breath.gas[MATERIAL_N2O] / breath.total_moles) * breath_pressure
		...
		breath.adjust_gas(MATERIAL_N2O, -breath.gas[MATERIAL_N2O]/6, update = 0) //update after
