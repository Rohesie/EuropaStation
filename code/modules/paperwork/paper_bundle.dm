...
/obj/item/paper_bundle/proc/insert_sheet_at(var/mob/user, var/index, var/obj/item/sheet)
...
/obj/item/paper_bundle/proc/burnpaper(var/obj/item/flame/P, mob/user)
	var/class = "warning"
...
/obj/item/paper_bundle/proc/show_content(var/mob/user)
	var/dat
...
/obj/item/paper_bundle/attack_self(var/mob/user)
	src.show_content(user)
	add_fingerprint(usr)
	update_icon()
	return
