...
var/list/default_onmob_icons = list(
		...
		slot_wear_id_str = 'icons/mob/clothing/id.dmi',
		slot_w_uniform_str = 'icons/mob/clothing/under.dmi',
		slot_wear_suit_str = 'icons/mob/clothing/suits.dmi',
		slot_head_str = 'icons/mob/clothing/head.dmi',
		...
		slot_gloves_str = 'icons/mob/clothing/gloves.dmi',
		slot_s_store_str = 'icons/mob/belt_mirror.dmi',
		slot_tie_str = 'icons/mob/clothing/ties.dmi'
		)